#!/usr/bin/env python3
"""
Test Quality Try-On V11: ControlNet Depth + FASHN Partial Masks + CatVTON

CRITICAL CHANGE from v10:
- v10: Full white masks → CatVTON ignores pose, all angles look identical
- v11: FASHN parse each realistic render → agnostic mask (upper_clothes + arms)
  → CatVTON preserves body pose, only replaces clothing region
...
Output:
- output/quality_tryon_v11/mesh_{0..315}.png
- output/quality_tryon_v11/realistic_{0..315}.png
- output/quality_tryon_v11/mask_{0..315}.png          (NEW: FASHN agnostic masks)
- output/quality_tryon_v11/fitted_{0..315}.png
- output/quality_tryon_v11/comparison_v11_part1.png
- output/quality_tryon_v11/comparison_v11_part2.png
"""
...
OUTPUT_DIR = ROOT / "output" / "quality_tryon_v11"
...
def create_comparison_grid(
    ...
    row_labels: list[str],
    angles: list[int],
    title: str = "V11 Pipeline Comparison",
) -> Image.Image:
...
def main():
    print("=" * 80)
    print("Quality Try-On V11: ControlNet Depth + FASHN Masks + CatVTON")
    print("=" * 80)
    ...
    grid1 = create_comparison_grid(
        ...
        title="V11 CN Depth + FASHN Mask + CatVTON (0-135 deg)",
    )
    grid1_path = OUTPUT_DIR / "comparison_v11_part1.png"
    ...
    grid2 = create_comparison_grid(
        ...
        row_labels=["Raw Mesh", "CN Depth", "FASHN Mask", "CatVTON"],
        angles=RENDER_ANGLES[4:],
        title="V11 CN Depth + FASHN Mask + CatVTON (180-315 deg)",
    )
    grid2_path = OUTPUT_DIR / "comparison_v11_part2.png"
    ...
    print("\n" + "=" * 80)
    print("V11 QUALITY TEST COMPLETE")
    print("=" * 80)
    ...
    print()
    print("V11 FASHN Partial Mask pipeline validation complete.")
    print("=" * 80)
